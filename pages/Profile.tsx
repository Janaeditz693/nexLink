...
const Profile: React.FC = () => {
  const { id } = useParams();
  const { currentUser, posts, followedUsers, likePost, followUser, updateCurrentUser, addComment } = useApp();
  ...
  return (
    <div className="flex-1 bg-background-light dark:bg-background-dark min-h-screen pb-24 overflow-y-auto no-scrollbar relative" ref={scrollRef}>
              ...
              >
                ...
                <div className="p-4 space-y-3">
                  <div className="flex items-center gap-5">
                    ...
                    <button onClick={() => setActiveCommentPostId(post.id)} className="flex items-center gap-1.5">
